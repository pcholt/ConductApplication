DROP DATABASE IF EXISTS `conduct_logic_question`;

CREATE_DATABASE `conduct_logic_question`;
...
INSERT INTO `agents` (`id`, `first_name`, `last_name`, `email`, `mobile`,
	`created`, `modified`,`active`) VALUES
